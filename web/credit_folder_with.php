...
if (empty($selectedMonth)) {
    ...
    header('Location: credit_folder_with.php');
    exit;
}

// Fetch deliveries for the selected delivery_m_y with status PENDING
$stmt = $pdo->prepare("SELECT * FROM for_deliveries WHERE delivery_m_y = ? AND status = 'CREDIT' ORDER BY id DESC");
...
<head>
    ...
    <title>Credit Folder With | <?= htmlspecialchars($selectedMonth) ?> | Villaruz Print Shop</title>
...
<body>
            ...
            <div class="folders-grid">
                <?php if (empty($deliveriesByDeliveryNumber)): ?>
                    <div class="empty-state">
                        ...
                        <p>No credit deliveries for <?= htmlspecialchars($selectedMonth) ?></p>
                    </div>
                <?php else: ?>
    ...
    <div id="totalPendingModal" class="system-modal-overlay">
        <div class="system-modal">
            <div class="system-modal-header">
                <i class="fas fa-coins"></i>
                <span>TOTAL CREDIT REPORT</span>
            </div>
            <div class="system-modal-content">
                <div class="system-modal-message info">
                    <i class="fas fa-chart-line"></i>
                    <div class="message-text">
                        Total credit amount for <strong><?= htmlspecialchars($selectedMonth) ?></strong>
        ...
        <div class="system-modal modal-summary">
            ...
            <div class="system-modal-content">
                <div class="summary-card">
                    ...
                    <div class="summary-row">
                        <div class="summary-label">
                            <i class="fas fa-coins"></i> Credit Sales Total
                        </div>
    ...
    <script>
        ...
        function viewCustomerOrders(deliveryNumber) {
            window.location.href = 'credit_orders.php?delivery_number=' + encodeURIComponent(deliveryNumber);
        }
