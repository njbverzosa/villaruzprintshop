...
function handleLogin($pdo)
{
    ...
    if ($userTypeSelected === 'Admin') {
        ...
        $stmt = $pdo->prepare("SELECT id, password, acc_number, phone_number, f_name, 'Customer' as role, status, email, active_email 
        ...
        // ==============================================
        if ($user && $user['active_email'] == 0) {
            $errors[] = 'Your account is temporarily blocked.';
