...
// ✅ Check if already logged in using unified session variables
    ...
    if (empty($errors)) {
        ...
        if ($userType && $user) {
            ...
            if ($userType === 'Admin') {
                ...
                // ✅ ONLY TWO SESSION VARIABLES FOR ADMIN
                $_SESSION['user_id'] = $user['id'];
                $_SESSION['acc_number'] = $user['acc_number'];
                $_SESSION['user_type'] = 'Admin'; // Keep this to identify user type
                ...
                // ✅ ONLY TWO SESSION VARIABLES FOR CUSTOMER
                $_SESSION['user_id'] = $user['id'];
                $_SESSION['acc_number'] = $user['acc_number'];
                $_SESSION['user_type'] = 'Customer'; // Keep this to identify user type
