    ...
    <main class="main-content">
        ...
        <div class="dashboard-header">
            ...
            <div class="user-badge">
                <div class="avatar"
                    style="<?php echo (isset($user['vip']) && $user['vip'] == 1) ? 'background: linear-gradient(135deg, #f59e0b, #f97316); font-size: 12px;' : ''; ?>">
                    <?php
                ...
                <?php if ($isVip): ?>
                    <span
                        style="font-size: 10px; color: #f59e0b; font-weight: 600; background: #fef3c7; padding: 2px 8px; border-radius: 12px;">
