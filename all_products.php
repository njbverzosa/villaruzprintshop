    ...
    <head>
        ...
        <style>
            * {
            ...
            .modal-content .product-info .name {
                font-size: 16px;
                font-weight: 700;
                color: #1a1a2e;
                font-family: Arial, sans-serif
            ...
            .modal-content .product-info .number {
                font-size: 12px;
                color: #6b7280;
                font-family: 'Courier New', monospace
            }
    ...
    <body>
        <div class="qr-grid">
            <?php if (empty($products)): ?>
                <div class="no-products"><i class="fas fa-box-open"></i>
            ...
            <?php else: ?>
                <?php foreach ($products as $product):
                    ...
                    <div class="qr-item">
                        ...
                        <div class="qr-image"
                            onclick="openQRModal('<?php echo $qrImage; ?>', '<?php echo htmlspecialchars($product['product_name']); ?>', '<?php echo htmlspecialchars($productNum); ?>')">
                            <img src="<?php echo $qrImage; ?>"
                                alt="QR Code for <?php echo htmlspecialchars($product['product_name']); ?>" loading="lazy"
                                onerror="this.style.display='none'; this.parentElement.innerHTML='<span style=\'font-size:10px;color:#9ca3af;\'>Error</span>'">
                        </div>
    ...
    <head>
        ...
        <style>
            * {
            ...
            .qr-code-section .qr-image:hover {
                border-color: #1a1a2e;
                transform: scale(1.05)
            }

            .qr-code-section .qr-image img {
                width: 100%;
                height: 100%;
                object-fit: contain
            }
    ...
    <body>
        <div class="price-container">
            <div class="price-card">
                ...
                <div class="product-number-display"><i class="fas fa-hashtag" style="font-size:11px;color:#9ca3af;"></i>
                    <?php echo $productNumberDisplay; ?></div>
                <div class="qr-code-section">
                    <div class="qr-label"><i class="fas fa-qrcode"></i> Scan to see price</div>
                    <div class="qr-image" onclick="window.open('<?php echo $qrImageUrl; ?>','_blank')"
                        title="Scan to see price">
                        <img src="<?php echo $qrImageUrl; ?>" alt="QR Code"
                            onerror="this.style.display='none'; this.parentElement.innerHTML='<div style=\'display:flex;align-items:center;justify-content:center;height:100%;color:#9ca3af;font-size:12px;\'>QR Error</div>'">
                    </div>
                </div>
